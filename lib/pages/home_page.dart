                  ...
                  Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return ItemCard(
                          screenSize: screenSize,
                          itemName: skins[index].skinName,
                          itemPrice: skins[index].price.toString(),
                          imagePath: skins[index].picture,
                          buttonPress: skins[index].itemPressed,
                        );
                      },
                    ),
                  ),
